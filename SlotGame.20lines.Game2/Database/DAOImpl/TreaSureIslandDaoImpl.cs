...
namespace SlotGame._20lines.Game2.Database.DAOImpl
{
    public class TreaSureIslandDaoImpl : ITreaSureIslandDao
    {
        ...
        public AccountInfo GetAccountInfo(int accountID, string username, int roomId, MoneyType moneyType)
        {
            try
            {
                ...
                pars[5] = new SqlParameter("@_LastLineData", SqlDbType.VarChar, 100) { Direction = ParameterDirection.Output };
                ...
                pars[8] = new SqlParameter("@_BonusData", SqlDbType.VarChar, 500) { Direction = ParameterDirection.Output };
                ...
                return new AccountInfo()
                {
                    ...
                    BonusData =pars[8].Value != DBNull.Value ? pars[8].Value.ToString() : "",
                    ResponseStatus = pars[9].Value != DBNull.Value ? int.Parse(pars[9].Value.ToString()) : -99
                };
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        public long FinisBonusGame(MoneyType moneyType, long spinId, ref long totalPrizeValue, ref long balance)
        {
            try
            {
                ...
                new DBHelper(Config.Game2ConnectionString).ExecuteNonQuerySP("SP_BonusGameSpins_Finish", pars);
                if (moneyType == MoneyType.Gold)
        ...
        public DataTable GetHistory(MoneyType moneyType, long accountId, int top)
        {
            try
            {
                ...
                DBHelper db = new DBHelper(Config.Game2ConnectionString);
        ...
        public JackpotHistoryList GetJackpotHistory(MoneyType moneyType, int currentPage, int pageSize)
        {
            ...
            try
            {
                ...
                var result =
                    new DBHelper(Config.Game2ConnectionString).GetListSP<JackpotHistory>(
        ...
        public int SetTestData(string accountName, string slotsData)
        {
            try
            {
                ...
                new DBHelper(Config.Game2ConnectionString).ExecuteNonQuerySP("SP_Spins_SetSlotsDataTest", pars);
        ...
        public string GetTestData(string accountName)
        {
            try
            {
                ...
                new DBHelper(Config.Game2ConnectionString).ExecuteNonQuerySP("SP_Spins_GetSlotsDataTest", pars);
        ...
        public DataTable GetTop2Jackpot()
        {
            try
            {
                return new DBHelper(Config.Game2ConnectionString).GetDataTableSP("[dbo].[SP_SlotDiamond_GetLastestJackpot]");
