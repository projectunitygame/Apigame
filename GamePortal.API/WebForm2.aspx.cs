...
namespace GamePortal.API
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ss = ConnectionStringUtil.Decrypt(t);
            this.lblMsg1.Text = ss;
            string s = ConnectionStringUtil.Encrypt(ss.Replace("45.32.99.34", "34.87.33.152").Replace("sa", "ugame").Replace("Uwin@2019", "123456"));
        ...
        {
            this.TextBox3.Text = ConnectionStringUtil.Encrypt(this.TextBox1.Text);
        }
